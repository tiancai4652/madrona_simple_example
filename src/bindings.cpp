...
NB_MODULE(_madrona_simple_example_cpp, m) {
    ...
    nb::class_<Manager> (m, "SimpleGridworldSimulator")
        ...
        .def("process_params_tensor", &Manager::processParamsTensor)
        .def("system_status_tensor", &Manager::systemStatusTensor)
        .def("inference_config_tensor", &Manager::inferenceConfigTensor)
        .def("inference_request_tensor", &Manager::inferenceRequestTensor)
        .def("workload_params_table_tensor", &Manager::workloadParamsTableTensor)
        .def("inference_stats_tensor", &Manager::inferenceStatsTensor)
