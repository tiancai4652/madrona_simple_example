...
static constexpr bool init_log_print_enabled = false;

inline void printInitTopoLog(const Sim &, Engine &) {}
inline void printInitFlowLog(const Sim &) {}
#else
static const bool init_log_print_enabled = []() {
...
inline void printInitTopoLog(const Sim &sim, Engine &ctx)
{
...
inline void printInitFlowLog(const Sim &sim)
{
    std::cout << std::fixed << std::setprecision(6);
