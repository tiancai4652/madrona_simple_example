...
constexpr int32_t MAX_FLOWS = 2742272;
constexpr int32_t MAX_PATH_NODES = 6;
constexpr int32_t MAX_ECMP_NEXT_HOPS = 36;
constexpr int32_t MAX_FLOW_ROUTE_STEPS = 6;
constexpr int32_t MAX_DELAYED_EVENTS = 12738560;
constexpr int32_t MAX_EVENTS_PER_STEP = 2294784;
constexpr int32_t MAX_TAG_INDEX = 10444800;
constexpr int32_t MAX_SOURCE_TAGS = 2611200;
