...
constexpr int32_t MAX_FLOWS = 137216;
constexpr int32_t MAX_PATH_NODES = 6;
constexpr int32_t MAX_ECMP_NEXT_HOPS = 20;
constexpr int32_t MAX_FLOW_ROUTE_STEPS = 6;
constexpr int32_t MAX_DELAYED_EVENTS = 618496;
constexpr int32_t MAX_EVENTS_PER_STEP = 99328;
constexpr int32_t MAX_TAG_INDEX = 520192;
constexpr int32_t MAX_SOURCE_TAGS = 130048;
