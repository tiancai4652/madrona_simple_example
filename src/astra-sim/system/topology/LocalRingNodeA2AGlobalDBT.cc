...
LocalRingNodeA2AGlobalDBT::LocalRingNodeA2AGlobalDBT(
    ...
    this->global_dimension_other = new RingTopology(RingTopology::Dimension::Vertical, id, total_tree_nodes,
                                                    id / (local_dim * node_dim), local_dim * node_dim);
    this->local_dimension = new RingTopology(RingTopology::Dimension::Local, id, local_dim, id % local_dim, 1);
    this->node_dimension = new RingTopology(RingTopology::Dimension::Horizontal, id, node_dim,
