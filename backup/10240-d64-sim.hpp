...
constexpr int32_t MAX_FLOWS = 1371136;
constexpr int32_t MAX_PATH_NODES = 6;
constexpr int32_t MAX_ECMP_NEXT_HOPS = 36;
constexpr int32_t MAX_FLOW_ROUTE_STEPS = 6;
constexpr int32_t MAX_DELAYED_EVENTS = 6369280;
constexpr int32_t MAX_EVENTS_PER_STEP = 1147904;
constexpr int32_t MAX_TAG_INDEX = 5222400;
constexpr int32_t MAX_SOURCE_TAGS = 1305600;
