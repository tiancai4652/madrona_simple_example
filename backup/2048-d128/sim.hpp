...
constexpr int32_t MAX_TOPO_NODES = 2240;
constexpr int32_t MAX_TOPO_LINKS = 6272;
constexpr int32_t MAX_TOPO_PORTS = 6272;
constexpr int32_t MAX_NODE_NEIGHBORS = 72;
constexpr int32_t MAX_FLOWS = 273408;
constexpr int32_t MAX_PATH_NODES = 6;
constexpr int32_t MAX_ECMP_NEXT_HOPS = 20;
constexpr int32_t MAX_FLOW_ROUTE_STEPS = 6;
constexpr int32_t MAX_DELAYED_EVENTS = 1236992;
constexpr int32_t MAX_EVENTS_PER_STEP = 197632;
constexpr int32_t MAX_TAG_INDEX = 1040384;
constexpr int32_t MAX_SOURCE_TAGS = 260096;
